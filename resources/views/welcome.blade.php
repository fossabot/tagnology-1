    ...
    <!-- <div class="panel panel-basic perpectual perpectual-md-3" data-offset="bottom">
            <div class="panel-header">
                ...
                <h4 aria-controls="collapse_search" aria-expanded="false" class="visible-sm visible-xs collapsed"
                    data-toggle="collapse">Search Criteria<span class=
                    ...
                    <form>
                        <div>
                            <div class="form-group">
                                <input autocomplete="off" class="form-control" id="key" maxlength="100" name="key"
                                       placeholder="Job Title or Keywords ..." title=
                            ...
                            <div class="form-group">
                                <input autocomplete="off" class="form-control" id="salary" maxlength="20" name="salary"
                                       placeholder="Minimum Salary (MYR)" type="text" value="">
                            </div>
                            <div class="form-group">
                                <button class="btn btn-primary btn-block" id="btnSubmit" title="Search Jobs Now"
                                        type="submit" value="Search"><strong>Search</strong></button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="panel-body">
                    <div class="list-panel-content">
                        <ol class="browse-type-list list-unstyled" id="browse_type_list">
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/malaysia/browse/specialization.html"
                                   id="browse_specialization" title=
                                   " Jobs by Specializations in Malaysia @ JobStreet.com">Specializations</a>
                            </li>
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/malaysia/browse/position-level.html"
                                   id="browse_position" title=
                                   " Jobs by Position Level in Malaysia @ JobStreet.com">Position Levels</a>
                            </li>
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/malaysia/browse/location.html"
                                   id="browse_location" title=
                                   " Jobs by Locations in Malaysia @ JobStreet.com">Locations</a>
                            </li>
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/malaysia/browse-company.php?by=company&amp;c=a"
                                   id="browse_company" title=
                        ...
                        <ol class="browse-type-list list-unstyled" id="browse_type_microsite_list">
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/malaysia/browse/oversea.html"
                                   id="browse_oversea" title=
                                   " Jobs Overseas in Malaysia @ JobStreet.com">Overseas Jobs</a>
                            </li>
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/campus/malaysia/job-opening.php"
                                   id="browse_campus" title=
                                   "Fresh Graduate Jobs in Malaysia @ JobStreet.com">Fresh Grad Jobs</a>
                            </li>
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/malaysia/job-classified.php"
                                   id="browse_classified" title=
                                   "Classified Jobs in Malaysia @ JobStreet.com">Classified Jobs</a>
                            </li>
                            <li>
                                <a href="http://job-search-dev.jobstreet.com.my/low-application/malaysia/job-opening.php"
                                   id="browse_low_app" title=
                                   "All Jobs looking for more Applicants in Malaysia @ JobStreet.com">Jobs looking for
                                    more Applicants</a>
                            </li>
                        </ol>
                    </div>
                ...
                <div class="panel-body">
                    <div class="list-panel-content">
                        <ol class="list-unstyled">
                            <li>
                                <a href="http://careers.jobstreet.com.my/interview/managing-bad-interview-questions"
                                   id="interview_tips_1" target="_blank" title=
                                   "Interview Questions - Managing Bad Interview Questions">Interview Questions</a>
                            </li>
                            <li>
                                <a href="http://careers.jobstreet.com.my/interview/winning-at-behavioural-interviews"
                                   id="interview_tips_2" target="_blank" title=
                                   "Behavioural Interviews">Behavioural Interviews</a>
                            </li>
                            <li>
                                <a href="http://careers.jobstreet.com.my/interview/success-at-interview-the-zagorski-way"
                                   id="interview_tips_3" target="_blank" title=
                                   "Interview Preparation">Interview Preparation</a>
                            </li>
                            <li>
                                <a href="http://careers.jobstreet.com.my/interview" id="interview_tips_4"
                                   target="_blank" title="More Interview Tips @ JobStreet.com">More Interview
                                    Tips..</a>
                            </li>
                        </ol>
                    </div>
